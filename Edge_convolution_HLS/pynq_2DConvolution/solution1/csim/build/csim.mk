...
HLS_SOURCES = ../../../source/conv2d_edge_tb.cpp ../../../source/conv2d_edge.cpp
...
$(ObjDir)/conv2d_edge_tb.o: ../../../source/conv2d_edge_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../source/conv2d_edge_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/conv2d_edge_tb.d

$(ObjDir)/conv2d_edge.o: ../../../source/conv2d_edge.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../source/conv2d_edge.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/conv2d_edge.d

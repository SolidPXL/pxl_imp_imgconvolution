# 1 "pynq_2DConvolution/source/conv2d_edge.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "pynq_2DConvolution/source/conv2d_edge.cpp" 2
# 1 "pynq_2DConvolution/source/conv2d_edge.h" 1
...
# 5 "pynq_2DConvolution/source/conv2d_edge.h" 2
...
__attribute__((sdx_kernel("conv2d_edge", 0))) void conv2d_edge(const pixel_t input[256][256], pixel_t output[256 -2][256 -2]) ;
# 2 "pynq_2DConvolution/source/conv2d_edge.cpp" 2
...
# 3 "pynq_2DConvolution/source/conv2d_edge.cpp" 2



__attribute__((sdx_kernel("conv2d_edge", 0))) void conv2d_edge(const pixel_t input[256][256],
                 pixel_t output[256 - 2][256 - 2]) {
#line 18 "C:/DevWorks/HAC/pynq_2DConvolution/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=conv2d_edge
# 7 "pynq_2DConvolution/source/conv2d_edge.cpp"

#line 7 "C:/DevWorks/HAC/pynq_2DConvolution/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=conv2d_edge
# 7 "pynq_2DConvolution/source/conv2d_edge.cpp"
...
#pragma HLS ARRAY_PARTITION variable=window type=complete dim=0
 ...
 VITIS_LOOP_32_1: for (int row = 0; row < 256; row++) {
        VITIS_LOOP_33_2: for (int col = 0; col < 256; col++) {
#pragma HLS PIPELINE II=1
 ...
 linebuf[0][col] = linebuf[1][col];
            ...
            if (row >= 2 && col >= 2) {
                ...
                VITIS_LOOP_44_3: for (int i = 0; i < 3; i++) {
#pragma HLS UNROLL
 VITIS_LOOP_46_4: for (int j = 0; j < 3; j++) {
#pragma HLS UNROLL
 window[i][j] = linebuf[i][col - 2 + j];
                ...
                int sum = 0;
                VITIS_LOOP_53_5: for (int i = 0; i < 3; i++) {
#pragma HLS UNROLL
 VITIS_LOOP_55_6: for (int j = 0; j < 3; j++) {
#pragma HLS UNROLL

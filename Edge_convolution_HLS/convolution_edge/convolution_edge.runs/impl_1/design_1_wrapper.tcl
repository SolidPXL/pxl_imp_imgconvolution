namespace eval ::optrace {
  variable script "C:/DevWorks/convolution_edge/convolution_edge.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/12300752/AppData/Roaming/Xilinx/Vivado/2024.1/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part tul.com.tw:pynq-z2:part0:1.0 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/DevWorks/convolution_edge/convolution_edge.cache/wt [current_project]
  set_property parent.project_path C:/DevWorks/convolution_edge/convolution_edge.xpr [current_project]
  set_property ip_repo_paths C:/DevWorks/HAC/pynq_2DConvolution/ip_repo [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/DevWorks/convolution_edge/convolution_edge.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/DevWorks/convolution_edge/convolution_edge.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/DevWorks/convolution_edge/convolution_edge.srcs/sources_1/bd/design_1/design_1.bd

...
using hls::sim::Byte;
extern "C" void conv2d_edge(Byte<1>*, Byte<1>*, int, int);
extern "C" void apatb_conv2d_edge_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 65536;
...
for (size_t i = 0; i < 64516; ++i){
__xlx_output_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_output_r)[i]);
}
  int __xlx_size_param_output_r = 64516;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*1;
  // DUT call
  conv2d_edge(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_output_r);

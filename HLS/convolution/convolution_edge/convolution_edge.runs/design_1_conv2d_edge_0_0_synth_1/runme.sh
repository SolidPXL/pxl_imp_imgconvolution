...
HD_PWD='C:/DevWorks/convolution_edge/convolution_edge.runs/design_1_conv2d_edge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_conv2d_edge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_conv2d_edge_0_0.tcl

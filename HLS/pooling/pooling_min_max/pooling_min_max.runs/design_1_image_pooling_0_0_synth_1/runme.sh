...
HD_PWD='C:/DevWorks/pooling_min_max/pooling_min_max.runs/design_1_image_pooling_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_image_pooling_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_image_pooling_0_0.tcl

namespace eval ::optrace {
  variable script "C:/DevWorks/pooling_min_max/pooling_min_max.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/DevWorks/pooling_min_max/pooling_min_max.cache/wt [current_project]
  set_property parent.project_path C:/DevWorks/pooling_min_max/pooling_min_max.xpr [current_project]
  set_property ip_repo_paths C:/DevWorks/HAC/pynq_pooling/ip_repo/export [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/DevWorks/pooling_min_max/pooling_min_max.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/DevWorks/pooling_min_max/pooling_min_max.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/DevWorks/pooling_min_max/pooling_min_max.srcs/sources_1/bd/design_1/design_1.bd

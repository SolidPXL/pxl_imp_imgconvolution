...
HLS_SOURCES = ../../../source/pooling_tb.cpp ../../../source/pooling.cpp
...
$(ObjDir)/pooling_tb.o: ../../../source/pooling_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../source/pooling_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/pooling_tb.d

$(ObjDir)/pooling.o: ../../../source/pooling.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../source/pooling.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
